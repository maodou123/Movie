...
public class FmovieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(FmovieActivity.this,FdmovieActivity.class);
    ...
    private BaseSliderView.OnSliderClickListener onSliderClickListener=new BaseSliderView.OnSliderClickListener() {
        ...
        public void onSliderClick(BaseSliderView slider) {
            Toast.makeText(FmovieActivity.this,slider.getBundle().get("extra") + "",
